...
class Settings:
    ...
    _origins_raw: str = os.getenv(
        "ALLOWED_ORIGINS",
        "https://guest-posting-ai.vercel.app,http://localhost:8000,http://127.0.0.1:8000,http://localhost:5173,http://localhost:5174,http://127.0.0.1:5173,http://127.0.0.1:5174,http://localhost:3000"
    )
